...
// AppPackageSpec defines the desired state of AppPackage
type AppPackageSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of AppPackage. Edit apppackage_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// AppPackageStatus defines the observed state of AppPackage
...
// AppPackage is the Schema for the apppackages API
